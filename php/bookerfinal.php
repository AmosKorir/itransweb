...
{
		$sql="INSERT INTO transaction(`ticketcode`,`allocationid`,`customerid`,`amount`,`date`,`seats`)VALUES
		('$newticketcode','$allocationid','$customer->customerid','$amount','$date','$adults')
		";
		$database->query($sql);
