...
<div class="col-3"><label  style="color:#F00" class="control-label"><?php if($customer->balance<$adults*($bus->fare)){echo"Balance insufficient";}?></label></div>
...
<button type="submit" style="margin-top:20px" class="btn btn-success">Confirm details and payment</button>
<span style="color:red;font-size:10px">**When you press this button you confirm booking of ticket.**<br/></span>
